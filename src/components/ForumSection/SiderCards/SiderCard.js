...
import { CardContainer, Header, Wrapper, ButtonWrapper } from './SiderCardElement'
        ...
        <>
            <CardContainer>
                <Wrapper>
                    ...
                    {data.map((item,index)=>(
                    <SiderPost key={index} title={item.title} author={item.created_by} date_post={item.created_at} />
                    ))}
                    <ButtonWrapper>
